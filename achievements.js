const ACHIEVEMENTS = [
    ...
    [
        ...
        { name: '7次方增长', desc: '购买自动抽取器 #8。' },
        { name: '量子隧穿', desc: '幸运乘数达到e2.25e23。\n奖励：在生成器界面解锁一个升级。' }
    ],
    [
        { name: '增益拉满', desc: '自动抽取器 #1倍率超过1000。\n每完成一个第四行中的成就，幸运值获取间隔/1.1。' },
        { name: '再也不需要连点器了', desc: '自动点击速度达到100/s。' },
        { name: '简单', desc: '完成C1×1。' },
        { name: '有点难', desc: '完成C3×3。' },
        { name: '上强度', desc: '完成C5×5。' },
        { name: '你就是个错误', desc: '在一个挑战中失败。\n奖励：一种挫败感。' }, // 其实没有实际效果
        { name: '小孩子才做选择，这些挑战我全都要', desc: '完成C8×5。' },
        { name: '超维', desc: '每一个自动抽取器 #n都达到9-n级。\n奖励：第三行成就对自动抽取 #2-4生效。' }
    ]
];
...
const HIDDEN_ACHIEVEMENTS = [
    ...
    [
        ...
        { name: '还是不够熟练，下去再熟练去！', descUnfinished: '来，这么简单的挑战都通不了吗？刷精华去！胡了胡哨的。', descFinished: '55s内，在挑战中失败10次。' }
    ]
];
